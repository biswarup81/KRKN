  ...
  <div class="container clearfix">
    <div class="row featurette">
      <div class="col-md-12 pull-left text-justify">
        <h2 class="featurette-heading text-gradient">Seminar 2017</h2>
 ...
 <div class="gallery-content-panel clearfix col-lg-12 padding-off">
                		...
                		<div class="gallery-col col-lg-3 pull-left">
                        		<div class="gallery-col-inner col-lg-12 pull-left padding-off">
                                	<a class="light-box galler-link" href="images/gallery-img/img-7/img-1.jpg"><img src="images/gallery-img/img-7/img-1.jpg" width="800" height="600" alt="img" title="img"></a>	
                                </div>
                        </div>
