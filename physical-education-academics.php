...
<div id="" class="inner-page-banner clearfix full-width pull-left">
    ...
    <div class="innre-bann-img"><img src="images/bgicon.png" width="2374" height="1158" alt="img" title="img"></div>
    		<div class="container">
            		<h1 class="banner-heading">Department  of Physical Education</h1>
            </div>
    </div>
</div>
<!-- /.carousel -->
		...
		<div class="container  clearfix padding-off transparent-bg">
                ...
                <div class="faculties-list-row clearfix">
                        ...
                        <div class="faculties-col-inner col-lg-12 pull-left padding-off">
                                ...
                                <h3 class="faculti-name text-gradient">Dr. Jyostnasis Ghosh</h3>
                                <div class="faculti-qualification">M.P.E, M.Phil, Ph.D</div>
                        ...
                        <div class="faculties-col-inner col-lg-12 pull-left padding-off">
                                ...
                                <h3 class="faculti-name text-gradient">Dr. Santwana Mondal</h3>
                                <div class="faculti-qualification">M.P.E, Ph.D</div>
                                <div class="faculti-designation">(Govt. Approved)</div>
                                <a class="btn-gradient btn btn-small" href="">View Resume</a>
                                </div>
                        </div>
                        <div class="faculties-col col-lg-4 col-md-4 col-xs-12 pull-left ">
                        <div class="faculties-col-inner col-lg-12 pull-left padding-off">
                                ...
                                <h3 class="faculti-name text-gradient">Sri Surajit Das</h3>
                                <div class="faculti-qualification">M.P.E</div>
