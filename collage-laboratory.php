  ...
  <div class="container clearfix">
    <div class="row featurette">
      <div class="col-md-12 pull-left text-justify">
        <h2 class="featurette-heading text-gradient">Collage Laboratory</h2>
        <div class="entry-content-bquote">Well equipped Laboratories in Geography & Physical Education Deptts are there for the use of the students. </div>
