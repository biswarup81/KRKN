  ...
  <div class="container clearfix">
    <div class="row featurette">
      <div class="col-md-12 pull-left text-justify">
        <h2 class="featurette-heading text-gradient">National Service Scheme</h2>
        <div class="conten-block clearfix"><p>There are three units of National Service Scheme where the willing students, both boys & girls, actively participate to spread the academic knowledge in the wide society out side the institution. </p></div>
